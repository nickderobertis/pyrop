...
html_baseurl = "https://nickderobertis.github.io/pyrop" + '/'
...
html_theme_options = dict(
    nav_title=project,
    base_url="https://nickderobertis.github.io/pyrop",
    color_primary='indigo',
    color_accent='deep-purple',
    logo_icon='&#xe869',
    repo_url="https://github.com/nickderobertis/pyrop",
    repo_name="pyrop",
    globaltoc_depth=3,
)
...
texinfo_documents = [
    (master_doc, conf.PACKAGE_NAME, f'{conf.PACKAGE_NAME} Documentation',
     author, conf.PACKAGE_NAME, "Imperative-style railway-oriented programming in Python",
     'Miscellaneous'),
]
